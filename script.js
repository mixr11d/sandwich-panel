/* ==========================================================================
   1. إعدادات ومعرفات إعلانات جوجل للعميل الجديد (تعديل من مكان واحد)
   ========================================================================== */
const G_ID = 'AW-18156640938'; // ضع هنا معرف حساب إعلانات جوجل الجديد للعميل
const C_L = '4DRaCIzqy8AcEKq14dFD';    // ضع هنا لابل تتبع الاتصال الهاتفي الجديد للعميل
const W_L = 'WC7nCI_qy8AcEKq14dFD';    // ضع هنا لابل تتبع نقرة الواتساب الجديد للعميل
const F_L = 'imx0CJ_6y8AcEKq14dFD';    // ضع هنا لابل تتبع إرسال نموذج الطلب الجديد للعميل
