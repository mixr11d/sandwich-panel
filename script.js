...
const C_L = 'wLfHCP74m7AcEKq14dFD';    // ضع هنا لابل تتبع الاتصال الهاتفي الجديد للعميل
const W_L = 'H-gMCPn5m7AcEKq14dFD';    // ضع هنا لابل تتبع نقرة الواتساب الجديد للعميل
