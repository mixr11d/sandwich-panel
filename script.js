...
const G_ID = 'AW-18343971216'; // معرف حساب إعلانات جوجل للعميل
const C_L = 'p5wLCJDXrtUcEJCTi6tE';    // لابل تتبع الاتصال الهاتفي
const W_L = 'Pkd7CJPXrtUcEJCTi6tE';    // لابل تتبع نقرة الواتساب
const F_L = '1yBxCL-XxNUcEJCTi6tE';    // لابل تتبع إرسال نموذج الطلب
